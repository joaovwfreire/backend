...
<br/>
We are committed to respect and protect the privacy of the personal information we obtain from you through the Service and we have created this Privacy Policy to inform you about how we collect, use and share your personal information, and about our privacy practices in general.
<br/>
We are always ready to address your questions and concerns regarding this policy and our privacy practices. If you would like to contact customer service, please contact us using the contact form linked at the end of this Privacy Policy.
<br/>
...
Use of the Service is subject to our Terms of Service which is hereby incorporated and made part of our Site disclosures which shall include this Privacy Policy the Terms of Service and any other disclosures posted to the Site (collectively the “Site Disclosures”). By using the Service, you agree to be bound by our Site Disclosures. 
<br/>
<h2>Application of this Privacy Policy.</h2>

 This policy applies where <br/>
 a) we are acting as a data controller with respect to your personal data, in other words, where we determine the purposes and means of the processing of that personal data.
 <br/>This policy applies where we are collecting Personally Identifiable Information (as further described below) from individuals and sole proprietors and does not apply to the collection of data from corporate entities.
 <br/>This policy applies however we collect Personally Identifiable Information however accessed and / or used, whether via personal computers, mobile devices or otherwise.
 <br/>In the event while using the Service you may be directed to other websites that are operated and controlled by third parties that are beyond our control. This policy does not apply to the privacy practices of these third-party websites
 <br/>The terms contained in this Privacy Policy are in accordance with various privacy policy laws and regulations including those applicable in the United States including the California Online Privacy Protection Act (“COPPA”), the Nevada privacy law SB-220 and the General Data Protection Regulation 2016/679.
 <h2>What Type of Personal Information is Collected and How Do We Use It?</h2>
<br/>
Personally Identifiable Information. When you engage in certain activities via the Service you may provide information to us which may include personal information, which is information that may reasonably be used to identify you, such as your name, address, zip code, e-mail address, telephone number, credit card number, images you upload and other content you upload or provide to us. We may also collect information available on the web. In the event you enroll in the Service through a third party, such as Facebook or Google, or another party we may receive Personally Identifiable Information from such third party and by using the Service, you consent to our receipt and sharing of Personally Identifiable Information. We may use or share Personally Identifiable Information to provide products and/or services to you, to enable third-parties to provide products and/or services to you, to enter a sweepstakes or contest, to enhance the operation of the Service, improve our marketing and promotional efforts, analyze use of the Service, and tailor your experience with third parties as provided below in this Privacy Policy. We may also use Personally Identifiable Information to troubleshoot, resolve disputes, accomplish administrative tasks, contact you, enforce our agreements with you, including our Terms and Conditions and this Privacy Policy, and to comply with applicable laws and cooperate with law enforcement activities. The legal basis for this processing is your consent or our legitimate interests, namely monitoring and improving our website and service.
...
<br/>
 ...
 <br/>
 We may process your account data ("account data"). In the event you register to use the Service, the account data may include your name and email address. The source of the account data is you. The account data may be processed for the purposes of operating our website, providing our services, ensuring the security of our website and services, maintaining back-ups of our databases and communicating with you. The legal basis for this processing is your consent or our legitimate interests, namely monitoring and improving our website and services.
 <br/>
 ...
 <br/>
 Please do not supply any other person's personal data to us unless we prompt you to do so.<br/>
...
<br/>
Advertising Privacy Settings. FOR EU USERS ONLY: When you use our site, pre-selected companies may access and use certain information on your device and about your interests to serve ads or personalized content. You may revisit or change consent-choices at any time by clicking here.
<br/>
<h2>Cookies that we use </h2>
 We may use cookies for the following purposes:
 <br/>
authentication - we use cookies to identify you when you visit our website and as you navigate our website.<br/>
status - we use cookies to help us to determine if you are logged into our website.<br/>
personalization - we use cookies to store information about your preferences and to personalize the website for you.<br/>
security - we use cookies as an element of the security measures used to protect user accounts, including preventing fraudulent use of login credentials, and to protect our website and services generally.
<br/>advertising - we use cookies to help us to display advertisements that will be relevant to you.
<br/>analysis - we use cookies to help us to analyze the use and performance of our website and services; and
<br/>cookie consent - we use cookies to store your preferences in relation to the use of cookies more generally.
...
<br/>https://support.google.com/chrome/answer/95647?hl=en (Chrome);
<br/>https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences (Firefox);
<br/>http://www.opera.com/help/tutorials/security/cookies/ (Opera);
<br/>https://support.microsoft.com/en-gb/help/17442/windows-internet-explorer-deletemanage-cookies (Internet Explorer);
<br/>https://support.apple.com/kb/PH21411 (Safari); and
<br/>https://privacy.microsoft.com/en-us/windows-10-microsoft-edge-and-privacy (Edge).
<br/>Blocking all cookies will have a negative impact upon the usability of many websites.
<br/>If you block cookies, you will not be able to use all the features on our website.
<br/>
...
<br/>
<h2>Age. </h2>
The Service is not directed to individuals under the age of thirteen (18). If you become aware that your child has provided us with personal information please contact us at the email address listed below. If we become aware that a child under this age has provided us with personal information, we will take steps to remove such information and terminate the child’s account.
<br/>
<h2>Rights. </h2> 
...
<br/>
<h2>Other </h2>
Our services make use of the YouTube API Services to authenticate the ownership of the users owernship of their YouTube Channel. The data collected is then used to provide a URL to their YouTube channels from the users profile page(s). The only information collected is publicily available identifier information of the users channel. That do not require User Credentials to collect. YouTube's Terms of Service is available at: https://www.youtube.com/t/terms. Users can manage apps security permissions for Google here: https://myaccount.google.com/permissions.
<br/>
<h2>Contact Us </h2>

For additional inquiries about the privacy of your information, you can contact us by emailing us at jovi@gamepayy.com
    </p>
    </div>
  );
};
